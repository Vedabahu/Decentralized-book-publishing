export const USER_AUTH_ADDRESS = process.env.NEXT_PUBLIC_USER_AUTH_ADDRESS as `0x${string}`;
export const BOOK_COVER_ADDRESS = process.env.NEXT_PUBLIC_BOOK_COVER_ADDRESS as `0x${string}`;

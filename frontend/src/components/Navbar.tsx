...
export default function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-40 border-b border-slate-200/70 bg-white/75 shadow-sm backdrop-blur-md transition-all duration-300">
      <nav className="mx-auto flex w-full max-w-6xl flex-wrap items-center justify-between gap-3 px-5 py-4 sm:px-8">
        <Link
          href="/"
          className="text-lg font-semibold tracking-tight text-slate-900 transition duration-200 hover:text-slate-700"
        >
          BookChain
        </Link>
